...
/// <summary>
/// Micro-inverter production telemetry data for a system.
/// </summary>
public class GetProductionMicroTelemetryResponse
{
    ...
    [JsonPropertyName("intervals")] public List<TelemetryInterval>? Intervals { get; set; }
