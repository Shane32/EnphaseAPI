...
/// <summary>
/// Energy export telemetry data for a system.
/// </summary>
public class GetEnergyExportTelemetryResponse
{
    ...
    /// <summary>Gets or sets the total number of export meter devices.</summary>
    ...
    /// <summary>Gets or sets the list of per-meter export telemetry intervals.</summary>
