# GET /api/v4/systems/{system_id}/energy_export_telemetry — Energy Export Telemetry

Retrieves energy exported to the grid in regular intervals.
...
**Method:** `GET`  
**Endpoint:** `/api/v4/systems/{system_id}/energy_export_telemetry`
...
### 200 — Energy Export Telemetry in Intervals
...
| `intervals[][].wh_exported` | integer | Energy exported to the grid in Wh during this interval |
