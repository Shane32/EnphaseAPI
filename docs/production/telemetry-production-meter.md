# GET /api/v4/systems/{system_id}/telemetry/production_meter — Telemetry: Production Meters
...
**Method:** `GET`  
**Endpoint:** `/api/v4/systems/{system_id}/telemetry/production_meter`
...
| `total_devices` | integer | Total number of production meter devices |
...
- [Telemetry: Production Micro](telemetry-production-micro.md) — Telemetry for all production micros
- [RGM Stats](rgm-stats.md) — Revenue-grade meter interval statistics
- [Telemetry: Consumption Meter](../consumption/telemetry-consumption-meter.md) — Consumption meter telemetry
