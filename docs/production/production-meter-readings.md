# GET /api/v4/systems/{system_id}/production_meter_readings — Production Meter Readings
...
**Method:** `GET`  
**Endpoint:** `/api/v4/systems/{system_id}/production_meter_readings`
...
| `meter_readings[].serial_number` | string | Meter serial number |
...
- [Consumption Meter Readings](../consumption/consumption-meter-readings.md) — Last known consumption meter readings
